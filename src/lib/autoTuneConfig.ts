...
export function buildAutoTuneConfig(
  ...
  return {
    ...
    weightPackage: draft.weightPackage ?? "stock",
    chassisPackage: draft.chassisPackage ?? "stock",
    powerStage: draft.powerStage ?? "stock",
    tirePackage: draft.tirePackage ?? "semi",
    transPackage: draft.transPackage ?? "race",
    brakePackage: draft.brakePackage ?? "sport",
    aeroPackage: draft.aeroPackage ?? "none",
    springFrontMin: draft.springFrontMin,
    springFrontMax: draft.springFrontMax,
    springRearMin: draft.springRearMin,
    springRearMax: draft.springRearMax,
