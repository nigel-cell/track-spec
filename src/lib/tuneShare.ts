...
export function buildSharePayload(
  ...
  return {
    ...
    springFrontMin: config.springFrontMin,
    springFrontMax: config.springFrontMax,
    springRearMin: config.springRearMin,
    springRearMax: config.springRearMax,
...
export function sharePayloadToLoad(
  ...
  const draft: Partial<TuneConfig> = {
    ...
    weightPackage: payload.weightPackage as TuneConfig["weightPackage"] | undefined,
    chassisPackage: payload.chassisPackage as TuneConfig["chassisPackage"] | undefined,
    powerStage: payload.powerStage as TuneConfig["powerStage"] | undefined,
    tirePackage: payload.tirePackage as TuneConfig["tirePackage"] | undefined,
    transPackage: payload.transPackage as TuneConfig["transPackage"] | undefined,
    brakePackage: payload.brakePackage as TuneConfig["brakePackage"] | undefined,
    aeroPackage: payload.aeroPackage as TuneConfig["aeroPackage"] | undefined,
    springFrontMin: payload.springFrontMin as number | undefined,
    springFrontMax: payload.springFrontMax as number | undefined,
    springRearMin: payload.springRearMin as number | undefined,
    springRearMax: payload.springRearMax as number | undefined,
